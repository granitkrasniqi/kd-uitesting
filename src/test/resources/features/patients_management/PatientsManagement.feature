Feature: Patients Management
  ...
  Scenario: Add a new Patient
      ...
      When the user creates a new patient with Personal Number 102258796 and name Granit and surname Krasniqi and gjinia Mashkull and date of birth 1998-04-10 and telephone number 04900000 and email gk@gmail.com and address Prishtine and description This is a test
